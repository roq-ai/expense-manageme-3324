...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'finance-manager', 'accountant', 'employee'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Earning', path: '/earnings', entity: 'earning', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    {
      name: 'Expenditure',
      path: '/expenditures',
      entity: 'expenditure',
